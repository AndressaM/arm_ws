...
DQ operator*(DQ dq1, DQ dq2){
    ...
    dq.q(4) = dq1.q(0)*dq2d.q(0) - dq1.q(1)*dq2d.q(1) - dq1.q(2)*dq2d.q(2) - dq1.q(3)*dq2d.q(3) + dq1d.q(0)*dq2p.q(0) - dq1d.q(1)*dq2p.q(1) - dq1d.q(2)*dq2p.q(2) - dq1d.q(3)*dq2p.q(3);
    dq.q(5) = dq1.q(0)*dq2d.q(1) + dq1.q(1)*dq2d.q(0) + dq1.q(2)*dq2d.q(3) - dq1.q(3)*dq2d.q(2) + dq1d.q(0)*dq2p.q(1) + dq1d.q(1)*dq2p.q(0) + dq1d.q(2)*dq2p.q(3) - dq1d.q(3)*dq2p.q(2);
    dq.q(6) = dq1.q(0)*dq2d.q(2) - dq1.q(1)*dq2d.q(3) + dq1.q(2)*dq2d.q(0) + dq1.q(3)*dq2d.q(1) + dq1d.q(0)*dq2p.q(2) - dq1d.q(1)*dq2p.q(3) + dq1d.q(2)*dq2p.q(0) + dq1d.q(3)*dq2p.q(1);
    dq.q(7) = dq1.q(0)*dq2d.q(3) + dq1.q(1)*dq2d.q(2) - dq1.q(2)*dq2d.q(1) + dq1.q(3)*dq2d.q(0) + dq1d.q(0)*dq2p.q(3) + dq1d.q(1)*dq2p.q(2) - dq1d.q(2)*dq2p.q(1) + dq1d.q(3)*dq2p.q(0);
