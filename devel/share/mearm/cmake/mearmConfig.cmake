  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mearm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'andressa <andressa@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mearm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/andressa/arm_ws/src/mearm/${idir}'.  Ask the maintainer 'andressa <andressa@todo.todo>' to fix it.")
    endif()
